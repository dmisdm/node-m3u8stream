...
const universal_url_1 = require("universal-url");
...
let m3u8stream = (playlistURL, options = {}) => {
    const stream = new stream_browserify_1.PassThrough();
    ...
    const requestQueue = new queue_1.default((segment, callback) => {
        ...
        let req = miniget_1.default(universal_url_1.resolve(playlistURL, segment.url), options);
    ...
    stream.end = () => {
        ...
        stream_browserify_1.PassThrough.prototype.end.call(stream, null);
    };
    return stream;
};
